...
namespace Laba_3_MCV.Migrations
{
    /// <inheritdoc />
    public partial class inirt : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogDestination", x => new { x.BlogsId, x.DestinationId });
                    table.ForeignKey(
                        name: "FK_BlogDestination_Blogs_BlogsId",
                        column: x => x.BlogsId,
